...
public class ImageController {
    ...
    public ResponseEntity<ImageResponse> submitImage(
        ...
        // Validation du type (JPEG ou PNG)
        ...
        try {
            asyncService.processImageAsync(id, file.getBytes(), file.getOriginalFilename(), email);
        } catch (Exception e) {
    ...
    // DTO pour la réponse
    record ImageResponse(String id, String message) {}
}